export function randomNameGenerator(): string {
    ...
    const pickRandom: (arr: string[]) => string = arr => arr[Math.floor(Math.random() * arr.length)];
    ...
    // TODO refactor to use useId() - must be used in the component or maybe generate a separate UUID in the object?
